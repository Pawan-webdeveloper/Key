...
//   Enhanced Button with animations
  ...
  return (
    <motion.section 
      className="flex overflow-hidden flex-col items-center px-16 py-28 w-full text-black bg-pink-600 max-md:px-5 max-md:py-24 max-md:max-w-full"
      variants={backgroundVariants}
      initial="initial"
      animate="animate"
      style={{
        backgroundImage: "linear-gradient(120deg, #fbe2e9 0%, #f9c9db 80%, #fbe2e9 100%)",
        ...
        <div className="flex flex-wrap gap-10 justify-center items-start w-full max-md:max-w-full">
          {features.map((feature, index) => (
            <AnimatedFeatureCard 
              ...
              feature={feature} 
              index={index} 
              button={<Button>{feature.button}</Button>}
            />
